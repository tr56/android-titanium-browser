...
# Применение патча сертификата Минцифры с ограничением (.ru, .рф, .su)
python3 $SCRIPT_DIR/scripts/patch_russian_ca.py chrome/browser/net/profile_network_context_service.cc
export PATCHED=1
